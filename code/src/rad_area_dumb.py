...
alpha_radiator = 0.13
area_radiator = 2.1 * 1.6 * 0.25

print(f"{area_radiator = }")
...
bnds = ((2.7 ** 4, 1500 ** 4), (2.7 ** 4, 1500 ** 4), (283.15 ** 4, 298.15 ** 4))
args = (m, s)
# minimize the function with the given bounds
res = optimize.minimize(func, x0=np.array([sol[0] ** 4, sol[1] ** 4, 298. ** 4]),
